...
class Details4 extends Component {
  state={
    count:0,
    imgState:true,
  };
      ...
      <View style={styler.outermost}>
        <View style={styler.box1}>
          ...
          <View style={styler.mainImg}>
            <Image
              style={styler.food}
              source={require('../imgs/chin.png')}></Image>
          </View>
        </View>
          ...
          <View style={styler.b2}>
            <View style={styler.t1}>
              ...
              <View style={{justifyContent: 'center'}}>
                <Text style={{fontSize: 15, fontWeight: '800'}}> 320 kcal</Text>
              </View>
            </View>
            <View style={styler.t1}>
              <Image
              ...
              <View style={{justifyContent: 'center'}}>
                <Text style={{fontSize: 15, fontWeight: '800'}}> 1 pack</Text>
              </View>
            </View>
            <View style={styler.t1}>
              <Image
